var fixedRect, movingRect,gameO1,gameO2,gameO3,gameO4;
...
function draw() {
  ...
  if(isTouching(gameO2,movingRect) ||isTouching(gameO1,movingRect)||isTouching(gameO3,movingRect)||isTouching(gameO4,movingRect)){
